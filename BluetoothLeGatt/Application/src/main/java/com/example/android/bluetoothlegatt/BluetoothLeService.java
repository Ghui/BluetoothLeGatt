...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback1 = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            Log.d(TAG,"onCHAR READ in callback 1");
        }
    ...
    private void broadcastUpdate(final String action,
        ...
        /*if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            if (data != null && data.length > 0&&device ==0) {
                ...
                String DecData =HexAsciiConverter.HexAscii2Decimal(DATA);
                Log.d(TAG,"MY DATA IN DECIMAL "+ DecData);
                intent.putExtra(EXTRA_DATA1, /*new String(data) +*/ " " + DecData);
                //String DataS = stringBuilder.toString();
    ...
    public boolean onUnbind(Intent intent) {
        ...
        //AUTOMATICALLY CONNECT TO ALL DEVICE
    ...
    public boolean connect(final String address,int devicenum) {
        ...
        // parameter to false.
        if(devicenum==0){
            mBluetoothGatt1 = device.connectGatt(this,false,mGattCallback1);
            mBluetoothDeviceAddress= address;
            mConnectionState = STATE_CONNECTING;
            Log.d(TAG,"GATTCALL BACK !!!!!!!!!!  "+address);
        }
        else if(devicenum ==1){
            mBluetoothGatt = device.connectGatt(this, false, mGattCallback);
            mBluetoothDeviceAddress1=address;
            mConnectionState = STATE_CONNECTING;
            Log.d(TAG,"GATTCALLBACK  "+address);
        }
